...
class TextStyles {
  ...
  static final titleCardHistorico = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: FontWeight.bold,
    color: AppColors.blackTextHistorico,
  );
  static final descriptionCardHistorico = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.normal,
    color: AppColors.blackTextHistorico,
  );
  static final textLucros = GoogleFonts.poppins(
    fontSize: 24,
    fontWeight: FontWeight.bold,
    color: AppColors.blackTextHistorico,
  );
  static final textCard = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.bold,
    color: AppColors.whiteMilk,
  );
  static final textHistorico = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: FontWeight.bold,
    color: AppColors.whiteMilk,
  );
